...
const costsFlat = document.getElementById('costs-flat'),
      ...
      constsCredit = document.getElementById('costs-credit');
...
const countingAvailableMoney = () => {
    ...
    const totalCosts = strToNum(costsFlat) + strToNum(costsHouseServices) + strToNum(costsTransport) + strToNum(constsCredit);
    //console.log(totalPerMonth,totalCosts)

    totalMonth = totalPerMonth - totalCosts;
    
    //console.log(totalPerMonth,"-",totalCosts,'=',totalMonth)
